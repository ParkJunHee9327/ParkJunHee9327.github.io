...
물론 내게도 어려운 이들을 돕고자 하는 사명감이 있다. 나 하나가 아닌 공동체 전체를 위한 삶을 지향한다. 나는 여름마다 홍수로 인해 큰 피해를 입은 지역의 농경지를 복구하는 수해 복구 봉사활동을 3년 간 개근하고 있다. <br>
사명감과 같은 사회복지의 *가치*도 분명한 나의 관심사다. 그러나 더욱 관심이 있는 것은 이성적인, *측정 가능하고 객관적인* 것들이었다. <br>
...
사람에 대한 관심도 좋고, 어려운 분들을 돕는 것도 좋다. 그러나 그건 <u>막연하게</u> 이뤄져서는 안 된다. 사회복지사는 사회적 약자의 삶의 질을 끌어올리고 보편적 복지를 실현하는 **전문가**다. 전문가에게는 **니즈를 파악하는 역량, 달성 가능한 목표로 치환하는 능력, 프로젝트 계획 능력, 프로젝트의 효과/효율을 측정하는 능력**이 필요하다.

<br>

<br>

혹자는 나에게 "사회적 약자들을 돕는 일을 돈벌이 사업처럼 하려는 거냐!"라고 반문할지도 모르겠다. 나의 관점을 더욱 펼치기 전에 오해를 풀 필요성을 느낀다.
...
논리나 이성에 기반하여 판단하는 나의 모습은 같은 학과의 친구들 내에서 "별종" 취급을 받았다. <br>
-> 너는 상황을 논리적으로 판단하는 것 같다. <br>
-> 감정적인 다른 친구들과는 다르다. <br>

때로는 이런 반응도 보였다. (나의 무엇을 보고 그렇게 생각하나?라고 물었을 때 뚜렷한 답을 한 친구가 없었다. 말로 설명하기 어려운 나의 인상인 듯 하다.) <br>
-> 인상은 새내기인데 말하는 건 4학년이다. <br>
-> 말하는 단어에서 지성이 느껴진다.

<br>

이성과 논리에 기반한 "별종"같은 나의 관점은 때로는 탄탄한 근거와 주장을 담은 보고서로, 때로는 사회 이슈를 분석한 글로 나타났다. 조별 과제를 같이 했던 친구들이 나의 이러한 모습을 좋아했던 기억이 난다. 나 또한 나의 관점을 좋아한다.
...
코로나가 유행했던 시기라 Youtube를 조금만 둘러봐도 "00언어 기초 문법"같은 영상이 많았던 시기였다. 나는 패기롭게 C언어를 독학하기 시작했다. <br>
*가장 어려운 언어를 해도 재미가 있고 이해할 수 있으면 할 만 하겠지.* 라는게 나의 생각이었다. <br>
...
* (1순위) Docker + Grafana 중심의 모니터링 기능 기반 프로파일링(Pyroscope) 개발
